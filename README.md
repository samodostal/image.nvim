...
## How does it work?
When you open an image file (e.g. `portrait.png`, the open buffer becomes non-editable and non-saveable to ensure the file won't be overwritten. Then the buffer is filled with the ascii art generated by [ascii-image-converter](https://github.com/TheZoraiz/ascii-image-converter). I found out that plugin similiar to this was already implemented for vim in vimscript: [image.nvim](https://github.com/ashisha/image.vim), so you can consider this a modern, lua version.
